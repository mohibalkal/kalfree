  ...
  return (
    <div className="w-64 bg-black h-full flex flex-col pt-6 gap-2 resize-x hidden md:flex border-r border-[#282828] pb-32">
      ...
      <nav className="flex flex-col gap-2 px-2">
        <NavItem view={ViewState.HOME} icon={Home} label={t('home')} />
        <NavItem view={ViewState.SEARCH} icon={Search} label={t('search')} />
        <NavItem view={ViewState.LIBRARY} icon={Library} label={t('library')} />
      </nav>
      ...
      <div className="mt-6 px-2 flex flex-col gap-2">
        ...
        >
          ...
          <span className="font-bold text-sm">{t('create_playlist')}</span>
        </button>
        <button
        ...
        >
          ...
          <span className="font-bold text-sm">{t('liked_songs')}</span>
        </button>
      </div>
